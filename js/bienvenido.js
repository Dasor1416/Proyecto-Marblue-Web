function ver_total() {
    ...
    let tipo_proyecto = document.getElementById("form_tipop");
...
function enviar(){
  let totalq =document.forms.formulario.total.value;
  window.location = "insertar.php?$total=" +totalq
}
